...
public final class FragmentUsersInfoBinding implements ViewBinding {
  ...
  private FragmentUsersInfoBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
      @NonNull Guideline guideline4, @NonNull TableLayout table, @NonNull TextView textView7,
  ...
  public static FragmentUsersInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentUsersInfoBinding((ConstraintLayout) rootView, cardView, guideline4, table,
