...
public final class FragmentLoginBinding implements ViewBinding {
  ...
  private FragmentLoginBinding(@NonNull ConstraintLayout rootView, @NonNull CardView cardView,
      @NonNull CardView cardView2, @NonNull CardView cardView4, @NonNull Guideline guideline4,
  ...
  public static FragmentLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoginBinding((ConstraintLayout) rootView, cardView, cardView2, cardView4,
          guideline4, loginBtn, loginemail, loginpassword, loginprogressbar, signuptext, textView,
          textView5, textView6);
    }
